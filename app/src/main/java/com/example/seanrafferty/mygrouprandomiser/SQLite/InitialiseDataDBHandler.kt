...
class InitialiseDataDBHandler
{
    ...
    private fun InitialiseDemoPlayers()
    {
        ...
        _DB.InsertPlayer(Player(0, "David McCrory", 8))
        _DB.InsertPlayer(Player(0, "William Lawrence", 8))
        _DB.InsertPlayer(Player(0, "Sergei", 9))
        _DB.InsertPlayer(Player(0, "James Davidson", 7))
        _DB.InsertPlayer(Player(0, "Ryan Bevin", 8))
        _DB.InsertPlayer(Player(0, "Mark Latten", 7))
        _DB.InsertPlayer(Player(0, "Mark Lutton", 6))
        _DB.InsertPlayer(Player(0, "Tommy Owens", 8))
        _DB.InsertPlayer(Player(0, "Cormac Byrne", 8))
        _DB.InsertPlayer(Player(0, "Emmet Mulholland", 8))
